...
function(a) {
  ...
  function c() {
    ...
    var b = "click,dbclick,rightclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,touchstart,touchmove,touchend".split(","),
    d = this;
...
function(a) {
  function b(c) {
    ...
    this.setImage = function(b, c) {
      if (null == b) throw new Error("Node.setImage(): 路径为null!");
      var d = this;
      if ("string" == typeof b) {
        var e = j[b];
